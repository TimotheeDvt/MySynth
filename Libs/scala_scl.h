...
namespace scala {
        inline scale read_scl(std::ifstream& input_file) {
                /*
                ...
                while (input_file) {
                        ...
                        if (std::regex_match (buffer, COMMENT_REGEX)) {
                                ...
                                if (non_commnets_processed == 0) {
                                        ...
                                        scala_scale.description = trimmed.str();
                                        description_parsed = true;
                                        non_commnets_processed = non_commnets_processed + 1;
                                        continue;
                                }
                                        ...
                                        scala_scale.addDegree(*new degree(cents));
                                }
                                        ...
                                        scala_scale.addDegree(*new degree(numerator, denominator));
