...
public:
        OscComponent(juce::AudioProcessorValueTreeState& apvts, juce::String waveSelectorId, juce::String oscGainId, juce::String fmFreqId, juce::String fmDepthId);
...
private:
        ...
        juce::Label oscGainLabel {"OSC1GAIN", "Gain"};
